  ...
  return (
    <div className="flex flex-wrap items-center h-[100dvh] lg:justify-start bg-fixed bg-cover bg-center custom-img">
      ...
      >
        ...
        <p className="py-6 text-xl lg:text-2xl font-bold text-primary/80">{message}</p>
        <motion.a 
          ...
          <span className=" flex items-center jus gap-2 relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 text-primary  font-bold cursor-pointer">
            Connect  
