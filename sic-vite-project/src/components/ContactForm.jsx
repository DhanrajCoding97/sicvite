      ...
      <Slide >
        <div className="py-20 px-32">
          ...
          <div className="flex gap-6 items-center justify-center w-full">
            <div
              className='bg-black-100 p-8 bg-black lg:rounded-3xl w-1/2'
            >
            ...
            <div className="w-1/2 p-8 flex flex-col gap-5 lg:mx-0 bg-black min-[430px]:rounded-3xl max-w-[700px] self-center">
          ...
          {/* <div
            className={`flex xl:flex-row flex-col xl:justify-evenly xl:gap-0 gap-10 pt-3 w-full max-w-7xl`}
          >
